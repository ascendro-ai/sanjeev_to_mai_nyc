// Custom icons for workflow example templates
  ...
  return (
    <div className="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center relative">
      ...
      <div className="w-8 h-6 bg-gray-200 rounded border border-gray-300 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-3 bg-pink-200 rounded-b" />
  ...
  return (
    <div className="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center relative">
      ...
      <div className="w-8 h-8 bg-gray-200 rounded border border-gray-300 flex items-end justify-center gap-1 p-1.5 relative">
        {/* Bar chart bars */}
        <div className="w-1.5 bg-green-400 rounded-t" style={{ height: '30%' }} />
        <div className="w-1.5 bg-green-500 rounded-t" style={{ height: '60%' }} />
        <div className="w-1.5 bg-green-600 rounded-t" style={{ height: '100%' }} />
        {/* Dollar sign */}
    ...
    <div className="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center relative">
      ...
      <div className="w-8 h-6 bg-gray-200 rounded border border-gray-300 relative p-1.5">
        ...
        <div className="space-y-0.5">
          <div className="h-0.5 bg-purple-300 rounded" style={{ width: '70%' }} />
          <div className="h-0.5 bg-purple-300 rounded" style={{ width: '85%' }} />
          <div className="h-0.5 bg-purple-300 rounded" style={{ width: '60%' }} />
        </div>
        {/* Purple dot bottom right */}
        <div className="absolute bottom-1 right-1 w-1.5 h-1.5 bg-purple-500 rounded-full" />
      </div>
    </div>
  )
}
